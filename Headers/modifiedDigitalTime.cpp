...
//File Name:  modifiedDigitalTime.cpp
...
DigitalTime::DigitalTime(int the_hour, int the_minute)
{
	...
	{
        throw DigitalTimeException(101, " This is completely messed up! Illegal argument to DigitalTime constructor.");
	}
	else
	{
		hour = the_hour;
...
void read_minute(istream& ins, int& the_minute)
{
	...
	{
        throw DigitalTimeException(102," This is completely messed up! Error illegal input to read_minute\n");
	}
	...
	{
       throw DigitalTimeException(103, " This is completely messed up! Error illegal input to read_minute\n");
	}
}
...
void read_hour(istream& ins, int& the_hour)
{
	...
	{
       throw DigitalTimeException(104, " This is completely messed up! Error both values need to be digits and the second value needs to == ':'\n");
	}
	...
	else //(isdigit(c1) && isdigit(c2))
	{
		...
		if (c2 != ':')
		{
            throw DigitalTimeException(105, " This is completely messed up! << Error illegal input to read_hour\n");
		}
	}
